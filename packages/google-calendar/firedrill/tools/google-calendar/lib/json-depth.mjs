...
// the parsed body iteratively (explicit stack, never recursion) and refuses it past MAX_JSON_DEPTH, answering 400 with
// this Tool's own Google-shaped error envelope before validation runs.
