// Minimal multipart/form-data parser for document uploads (UTF-8 text bodies only): linear scans, at most 8 parts.
...
function boundaryOf(contentType) {
  ...
  for (const raw of parts.slice(1, 16)) {
...
function dispositionParams(value) {
  ...
  for (const piece of pieces.slice(1, 16)) {
